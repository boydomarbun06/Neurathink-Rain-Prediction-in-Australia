...
if submitted:
    ...
    # --- PERBAIKAN DI SINI: Geser ke dalam blok 'if submitted' ---
    ...
    if prediction == 1:
        ...
        st.write(f"Probabilitas Hujan: **{prob[1]:.2%}**") # Menghapus 'Rose' jika tidak perlu
    else:
        st.success(f"### RESULT: NO (RainTomorrow)")
        st.write(f"Probabilitas Cerah: **{prob[0]:.2%}**")